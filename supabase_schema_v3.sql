-- ====================================================================
-- PERIMETRR STAFF ATTENDANCE PLATFORM (v3.0.0)
...
-- Standardized Workspace Code Format: ABCD-1234
-- --------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS public.tenants (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    slug VARCHAR(64) UNIQUE NOT NULL,
    name VARCHAR(128) NOT NULL,
    workspace_code VARCHAR(16) UNIQUE NOT NULL, -- Format: ABCD-1234
...
CREATE TABLE IF NOT EXISTS public.staff (
    ...
    name VARCHAR(128) NOT NULL,
    dept VARCHAR(64) DEFAULT 'General',
...
VALUES 
    ('acme', 'Test Subject 001', 'Engineering'),
    ('acme', 'Test Subject 002', 'Human Resources'),
    ('acme', 'Test Subject 003', 'Operations')
